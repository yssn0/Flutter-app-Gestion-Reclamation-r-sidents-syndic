//lib\syndic\présentation\list_reclamation_syndic.dart
import 'dart:async';
...
class _ListeReclamationSyndicState extends State<ListeReclamationSyndic> {
  ...
  Color _getButtonColor(String status) {
    return Color.fromRGBO(242, 250, 235, 1.0); // Color for 'Traité' status
  }

  Widget _getWidget(String status) {
    return Image.asset("assets/done.png", height: 18.h, width: 18.w);
  }
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Center(
              child: Text(
                "Liste des Réclamations Traitées",
            ...
            Expanded(
              child: isLoading
                  ...
                  : errorMessage != null
                      ...
                      : list.isEmpty
                          ? Center(child: Text("Aucune réclamation traitée trouvée"))
                          : ListView.builder(
